# Axis Individual Contributor License Agreement

> **Template notice.** This document is a template, adapted from the Apache
> Software Foundation Individual Contributor License Agreement (V2.0), with the
> party receiving the grant changed from a foundation to an individual. It has
> not been reviewed by a lawyer. Vir Sanghavi should have legal counsel review
> it before relying on it for substantial contributions.

Thank you for your interest in Axis (the "Project"), which is owned and
maintained by Vir Sanghavi ("the Owner"). This Contributor License Agreement
("Agreement") documents the rights granted by contributors to the Owner. This is
a legally binding document, so please read it carefully before agreeing to it.

This Agreement is for your protection as a contributor as well as the protection
of the Owner; it does not change your rights to use your own Contributions for
any other purpose.

You accept and agree to the following terms and conditions for Your present and
future Contributions submitted to the Owner. Except for the license granted
...
copyright owner that is making this Agreement with the Owner. For legal entities,
...
owned or managed by the Owner (the "Work"). For the purposes of this definition,
"submitted" means any form of electronic, verbal, or written communication sent
to the Owner or its representatives, including but not limited to communication
on electronic mailing lists, source code control systems, and issue tracking
systems that are managed by, or on behalf of, the Owner for the purpose of
...
For the avoidance of doubt, this license includes the right of the Owner to
license, sublicense, and distribute Your Contributions and derivative works of
them under any terms of the Owner's choosing, including proprietary and
closed-source terms, and the right to relicense Your Contributions under terms
different from the license under which the Work is otherwise distributed.
...
separate Corporate CLA with the Owner.
...
You signify Your agreement to this Agreement when You open a pull request against
the Project, by:

1. checking the Contributor License Agreement box in the pull request template,
   and
2. leaving a comment on the pull request that states: "I agree to the CLA."
